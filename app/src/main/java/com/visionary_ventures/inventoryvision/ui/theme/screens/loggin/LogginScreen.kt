package com.visionary_ventures.inventoryvision.ui.theme.screens.loggin
...
import com.visionary_ventures.inventoryvision.data.AuthViewModel
...
import com.visionary_ventures.inventoryvision.ui.theme.skyBlue


@Composable
fun Loggin_Screen(navController: NavHostController) {
...
@Composable
fun LoginPreview() {
    Loggin_Screen(rememberNavController())
}