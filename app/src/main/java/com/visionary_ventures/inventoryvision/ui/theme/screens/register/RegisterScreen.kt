package com.visionary_ventures.inventoryvision.ui.theme.screens.register
...
import com.visionary_ventures.inventoryvision.ui.theme.*
...
fun Register_Screen(navController: NavHostController) {
    ...
    Box(
        ...
        Column(
            ...
            // Login Button
            TextButton(
                onClick = { navController.navigate(ROUTE_LOGGIN) },
